...
<tr>
<td align="right" > <a href="${pageContext.request.contextPath}/employee_saveUI">添加</a></td>
</tr>
</table>
<br/>
...
<s:iterator value="list" var = "e">
	<tbody>
		...
		<td align="center"><a href="${pageContext.request.contextPath}/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath}/images/trash.gif" alt="删除"></a></td>
		</tr>
	</tbody>
</s:iterator >
</table>
